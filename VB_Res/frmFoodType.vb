...
Public Class frmFoodType
    Dim tcondition As String

    Private Sub frmFoodType_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call datagirdshow()
    ...
    Sub datagirdshow()
        ...
        Try
            ...
            Conn.Close()
            DataGridView1.Columns(0).HeaderText = "ລະຫັດປະເພດອາຫານ"
            DataGridView1.Columns(1).HeaderText = "ຊື່ປະເພດອາຫານ"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Conn.Open()
            Cmd = Conn.CreateCommand
            Cmd.CommandText = "select right(foodtype_id,len(foodtype_id)-2) from foodtype order by cast(right(foodtype_id,len(foodtype_id)-3) as int) asc"
            Dim da As New SqlDataAdapter(Cmd.CommandText, Conn)
            Dim dt As New DataTable("restuarant")
            da.Fill(dt)
            Conn.Close()
            Dim i As Integer = dt.Rows.Count - 1
            TextBox1.Text = "FT" & Val(dt.Rows(i)(0)) + 1
        Catch ex As Exception
            TextBox1.Text = "FT1"
            'MsgBox("Error: " & ex.Source & ": " & ex.Message, MsgBoxStyle.OkOnly, "Connection Error !!")
        End Try
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If tcondition = "New" Then
            Try
                ...
                conn.Open()
                cmd = conn.CreateCommand
                cmd.CommandText = "INSERT INTO foodtype([foodtype_ID],[foodtype_name]) VALUES(N'" & TextBox1.Text & "',N'" & TextBox2.Text & "')"
        ...
        ElseIf tcondition = "Update" Then
            Try
                ...
                conn.Open()
                cmd = conn.CreateCommand
                cmd.CommandText = "UPDATE foodtype SET foodtype_name = N'" & TextBox2.Text & "' where foodtype_ID= N'" & TextBox1.Text & "'"
                Dim da As New SqlDataAdapter(cmd.CommandText, conn)
                Dim dt As New DataTable("restuarant")
                da.Fill(dt)
                DataGridView1.DataSource = dt
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Try
            ...
            Conn.Open()
            Cmd = Conn.CreateCommand
            Cmd.CommandText = "delete from foodtype where foodtype_ID = '" & TextBox1.Text & "'"
